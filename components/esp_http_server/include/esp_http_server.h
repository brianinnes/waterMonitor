...
/**
 * @brief   Registers a URI handler to be called when no other handler matches (404-not found)
 *
 * @note    URI handlers can be registered in real time as long as the
 *          server handle is valid.
 * *
...
/**
 * @brief   Unregister the 404 URI handler
 *
 * @param[in] handle    handle to HTTPD server instance
 * @param[in] uri       URI string
 * @param[in] method    HTTP method
...
#define HTTPD_302      "302 Found"                  /*!< HTTP Response 302 */
